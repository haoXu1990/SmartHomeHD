...
extern NSString *const SRWebSocketErrorDomain2;
extern NSString *const SRHTTPResponseErrorKey2;
...
- (void)webSocket:(SRWebSocket2 *)webSocket didReceivePong:(NSData *)pongPayload;
